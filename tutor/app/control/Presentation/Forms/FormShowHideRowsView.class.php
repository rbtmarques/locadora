...
class FormShowHideRowsView extends TPage
{
    ...
    function __construct()
    {
        ...
        $this->form = new TQuickForm('form_show_hide');
        ...
        $this->form->addQuickField('Item price', $item_price, '30%');
        $this->form->addQuickField('Units', $units, '30%');
        $this->form->addQuickField('Hour price', $hour_price, '30%');
        $this->form->addQuickField('Hours', $hours, '30%');
