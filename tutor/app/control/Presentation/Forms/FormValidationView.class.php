...
class FormValidationView extends TPage
{
    ...
    function __construct()
    {
        ...
        $this->form->setFormTitle('Form validation');
        ...
        // add the form fields
        $this->form->addQuickField('1. Min length validator (3):',  $field1 );
        $this->form->addQuickField('2. Max length validator (20):', $field2 );
        $this->form->addQuickField('3. Min value validator (1):',   $field3 );
        $this->form->addQuickField('4. Max value validator (10):',  $field4 );
        $this->form->addQuickField('5. Required validator:',        $field5 );
        $this->form->addQuickField('6. Email validator:',           $field6 );
        $this->form->addQuickField('7. Numeric validator:',         $field7 );
        ...
        $this->form->addQuickAction('Send', new TAction(array($this, 'onSend')), 'fa:save green');
