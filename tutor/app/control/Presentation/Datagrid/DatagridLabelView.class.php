...
class DatagridLabelView extends TPage
{
    ...
    public function __construct()
    {
        ...
        // add the columns
        $this->datagrid->addQuickColumn('Code',  'code', 'center', 70);
        $this->datagrid->addQuickColumn('Task',  'task', 'left', 200);
        $column = $this->datagrid->addQuickColumn('Status', 'status', 'center', 340);
