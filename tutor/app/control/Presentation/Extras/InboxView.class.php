...
class InboxView extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->datagrid->addQuickAction('View', new TDataGridAction(array('MessageList', 'onLoad')), 'folder', 'fa:folder-open-o');
        ...
        // HERE: Prepare an area (message_area) to render MessageList
