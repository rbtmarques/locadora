<?php
/**
 * CollectionStaticSimpleDeleteView
 *
 * @version    1.0
 * @package    samples
 * @subpackage tutor
 ...
 */
class CollectionStaticSimpleDeleteView extends TPage
{
    public function __construct()
    {
        ...
        $source->loadFile('app/resources/Persistence/Collections/CollectionStaticSimpleDelete.php');
        $scroll->add($source);
