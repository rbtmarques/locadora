<?php
/**
 * CollectionStaticBatchUpdateView
 *
 * @version    1.0
 * @package    samples
 * @subpackage tutor
 ...
 */
class CollectionStaticBatchUpdateView extends TPage
{
    public function __construct()
    {
        ...
        $source->loadFile('app/resources/Persistence/Collections/CollectionStaticBatchUpdate.php');
        $scroll->add($source);
