<?php
/**
 * CollectionSimpleLoadPropertyView
 *
 * @version    1.0
 * @package    samples
 * @subpackage tutor
 ...
 */
class CollectionSimpleLoadPropertyView extends TPage
{
    public function __construct()
    {
        ...
        $source->loadFile('app/resources/Persistence/Collections/CollectionSimpleLoadProperty.php');
        $scroll->add($source);
