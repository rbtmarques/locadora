 ...
 */
class CollectionSimpleDeleteView extends TPage
{
    public function __construct()
    {
        ...
        $source->loadFile('app/resources/Persistence/Collections/CollectionSimpleDelete.php');
        $scroll->add($source);
