<?php
/**
 * CollectionStaticSimpleCountView
 *
 * @version    1.0
 * @package    samples
 * @subpackage tutor
 ...
 */
class CollectionStaticSimpleCountView extends TPage
{
    public function __construct()
    {
        ...
        $source->loadFile('app/resources/Persistence/Collections/CollectionStaticSimpleCount.php');
        $scroll->add($source);
