 ...
 */
class CollectionCountObjectsView extends TPage
{
    public function __construct()
    {
        ...
        $source->loadFile('app/resources/Persistence/Collections/CollectionCountObjects.php');
        $scroll->add($source);
