 ...
 */
class CollectionLoadPropertyView extends TPage
{
    public function __construct()
    {
        ...
        $source->loadFile('app/resources/Persistence/Collections/CollectionLoadProperty.php');
        $scroll->add($source);
