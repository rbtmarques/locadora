...
class CalendarEventForm extends TWindow
{
    ...
    public function __construct()
    {
        ...
        $table->addRowSet( new TLabel('Color:'), $color );
        $table->addRowSet( new TLabel('Start time:'), array($start_date, $start_hour, ':', $start_minute) );
        ...
        $this->form->setFields(array($id, $view, $color, $title, $description, $start_date, $start_hour, $start_minute, $end_date, $end_hour, $end_minute, $save_button,$new_button,$del_button));
